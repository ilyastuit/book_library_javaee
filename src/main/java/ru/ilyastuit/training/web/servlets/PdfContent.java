 ...
 */
package ru.ilyastuit.training.web.servlets;
...
import ru.ilyastuit.training.web.controllers.BookListController;
...
public class PdfContent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (save) {
                response.setHeader("Content-Disposition", "attachment;filename=" + URLEncoder.encode(request.getParameter("filename"), "UTF-8") + ".pdf");
            }
            out.write(content);
        } catch (Exception ex) {
            ex.printStackTrace();
